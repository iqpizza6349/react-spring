...
public class TokenProvider {
    ...
    public TokenDto createTokenDto(Long autoId, List<String> roles) {
        ...
        // 2시간 정도
        long accessTokenValidMilliSeconds = 7200 * 1000L;
        String accessToken = Jwts.builder()
                .setHeaderParam(Header.TYPE, Header.JWT_TYPE)
                .setClaims(claims)
                .setIssuedAt(new Date(now.getTime() + accessTokenValidMilliSeconds))
                .signWith(SignatureAlgorithm.HS256, secretKey)
                .compact();

        // 보름 정도
        long refreshTokenValidMilliSeconds = 15 * 24 * 60 * 60 * 1000L;
        ...
        return TokenDto.builder()
                ...
                .accessTokenExpireDate(accessTokenValidMilliSeconds)
                .build();
    }
